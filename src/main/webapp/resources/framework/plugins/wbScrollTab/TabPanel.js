...
TabPanel.prototype = {
    ...
    init: function () {
        ...
        this.tabpanel_left_scroll = $('<DIV><i class="ti-angle-left"></i></DIV>');
        ...
        this.tabpanel_right_scroll = $('<DIV><i class="ti-angle-right"></i></DIV>');
        ...
        var t_w = this.tabpanel.outerWidth();
        var t_h = this.tabpanel.outerHeight();
   ...
   * });
    ...
    resize: function () {
        ...
        if (this.heightResizable) {
            ...
            if(this.tabpanel_tab_content.css("display") == "none"){
